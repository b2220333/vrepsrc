...
void CQDlgPathPlanningParams::refresh()
{
    ...
    {
        ui->qqMinD->setText(tt::getEString(true,searchRangeMin[3]*radToDeg,1).c_str());
        ui->qqMinD_2->setText(tt::getEString(true,searchRangeMax[3]*radToDeg,1).c_str());
...
void CQDlgPathPlanningParams::on_qqStepSizeA_editingFinished()
{
    ...
    {
        newVal*=gv::userToRad;
        tt::limitValue(0.1f*degToRad,90.0f*degToRad,newVal);
