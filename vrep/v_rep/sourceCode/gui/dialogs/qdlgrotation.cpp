...
void CQDlgRotation::refresh()
{
    ...
    if (editMode==NO_EDIT_MODE)
    {
        ...
        // Mouse manip part:
        ui->qqOrWorld->setEnabled(object!=NULL);
        ui->qqOrParent->setEnabled(object!=NULL);
        ui->qqOrOwn->setEnabled(object!=NULL);
        ui->qqOrA->setEnabled(object!=NULL);
        ui->qqOrB->setEnabled(object!=NULL);
        ui->qqOrG->setEnabled(object!=NULL);
        ui->qqOrCombo->setEnabled(object!=NULL);
