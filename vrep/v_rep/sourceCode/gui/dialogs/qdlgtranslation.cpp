...
//            forbidManipWhenNotRunning=object->getObjectManipulationDisabledDuringNonSimulation();
        ...
        // mouse manip part:
       // ui->qqDisabledWhenRunning->setEnabled(object!=NULL);
       // ui->qqDisabledWhenNotRunning->setEnabled(object!=NULL);
        ui->qqPosWorld->setEnabled(object!=NULL);
        ui->qqPosParent->setEnabled(object!=NULL);
        ui->qqPosOwn->setEnabled(object!=NULL);
        ui->qqPosX->setEnabled(object!=NULL);
        ui->qqPosY->setEnabled(object!=NULL);
        ui->qqPosZ->setEnabled(object!=NULL);
        ui->qqPosCombo->setEnabled(object!=NULL);
//            ui->qqDisabledWhenRunning->setChecked((object!=NULL)&&forbidManipWhenRunning);
//            ui->qqDisabledWhenNotRunning->setChecked((object!=NULL)&&forbidManipWhenNotRunning);
        ...
        if (object!=NULL)
        {
            ...
            {
                if (object->getObjectManipulationDisabledDuringNonSimulation())
            ...
            {
                if (object->getObjectManipulationDisabledDuringSimulation())
                    _selectItemOfCombobox(ui->qqPosCombo,-1);
                else
                    _selectItemOfCombobox(ui->qqPosCombo,int((manipulationTranslationStepSize+0.0005f)*1000.0f));
            }
