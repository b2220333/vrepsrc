...
void CJoint::setVortexFloatParams(const std::vector<float>& p)
{
    ...
    if (_vortexFloatParams[simi_vortex_joint_p0stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_p0stiffness]=1e-35;
    if (_vortexFloatParams[simi_vortex_joint_p1stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_p1stiffness]=1e-35;
    if (_vortexFloatParams[simi_vortex_joint_p2stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_p2stiffness]=1e-35;
    if (_vortexFloatParams[simi_vortex_joint_a0stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_a0stiffness]=1e-35;
    if (_vortexFloatParams[simi_vortex_joint_a1stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_a1stiffness]=1e-35;
    if (_vortexFloatParams[simi_vortex_joint_a2stiffness]==0.0f)
        _vortexFloatParams[simi_vortex_joint_a2stiffness]=1e-35;
...
void CJoint::setEnableDynamicMotorCustomControl(bool c,const char* scriptContent,const std::vector<int>* foldingInfo)
{
    ...
    if (_dynamicMotorCustomControl&&(scriptContent!=NULL))
...
void CJoint::handleDynJointControl(bool init,int loopCnt,int totalLoops,float currentPos,float effort,float dynStepSize,float errorV,float& velocity,float& forceTorque)
{
    ...
    int callbackCount=getAllJointCtrlCallbacks().size();
    if (callbackCount!=0)
    {
        int intParams[3];
