...
// ******BULLET_MOD_6J_MODIFIED_BY_MARC
//void btSequentialImpulseConstraintSolver::setFrictionConstraintImpulse( btSolverConstraint& solverConstraint, 
//                                                                      btRigidBody* rb0, btRigidBody* rb1, 
//                                                               btManifoldPoint& cp, const btContactSolverInfo& infoGlobal)
void btSequentialImpulseConstraintSolver::setFrictionConstraintImpulse( btSolverConstraint& solverConstraint, 
                                                                        btRigidBody* rb0, btRigidBody* rb1, 
                                                                 btManifoldPoint& cp, const btContactSolverInfo& infoGlobal,btCollisionObject* colObj0,btCollisionObject* colObj1)
// ******BULLET_MOD_6J_MODIFIED_BY_MARC
{
...
//                      if ((infoGlobal.m_solverMode & SOLVER_USE_2_FRICTION_DIRECTIONS))
                        if(((infoGlobal.m_solverMode & SOLVER_USE_2_FRICTION_DIRECTIONS))||
                            (colObj0->m_collisionShape->stickyContact||colObj1->m_collisionShape->stickyContact)                                
                            )
// ******BULLET_MOD_6E_MODIFIED_BY_MARC
                        {
...
// ******BULLET_MOD_6I_MODIFIED_BY_MARC
            // setFrictionConstraintImpulse( solverConstraint, rb0, rb1, cp, infoGlobal);
            setFrictionConstraintImpulse( solverConstraint, rb0, rb1, cp, infoGlobal,colObj0,colObj1);
// ******BULLET_MOD_6I_MODIFIED_BY_MARC
...
//****************************************************************************************************
#define BULLET_MOD_4B_MODIFIED_BY_MARC // following 7 lines:
                    for (int kkk=0;kkk<6;kkk++)
                        constraint->m_appliedImpulse_byMarc[kkk]=0.0f;
                    for ( j=0;j<info1.m_numConstraintRows;j++)
                    {
                        currentConstraintRow[j].m_constraintIndex_byMarc=i;
                        currentConstraintRow[j].m_constraintIndexEqNb_byMarc=j;
                    }
//****************************************************************************************************
...
//****************************************************************************************************
#define BULLET_MOD_4C_MODIFIED_BY_MARC // following 3 lines:
                    int ind=constraint.m_constraintIndex_byMarc;
//                  if ( (constraints[ind]->getObjectType()==HINGE_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==SLIDER_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==POINT2POINT_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==D6_CONSTRAINT_TYPE) )
// removed on 1/6/2011                  if (constraints[ind]->getObjectType()==D6_CONSTRAINT_TYPE)
                        constraints[ind]->m_appliedImpulse_byMarc[constraint.m_constraintIndexEqNb_byMarc]=constraint.m_appliedImpulse;
//****************************************************************************************************
        }
...
//****************************************************************************************************
#define BULLET_MOD_4E_MODIFIED_BY_MARC // following 3 lines:
                    int ind=constraint.m_constraintIndex_byMarc;
//                  if ( (constraints[ind]->getObjectType()==HINGE_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==SLIDER_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==POINT2POINT_CONSTRAINT_TYPE)||(constraints[ind]->getObjectType()==D6_CONSTRAINT_TYPE) )
// removed on 1/6/2011                  if (constraints[ind]->getObjectType()==D6_CONSTRAINT_TYPE)
                        constraints[ind]->m_appliedImpulse_byMarc[constraint.m_constraintIndexEqNb_byMarc]=constraint.m_appliedImpulse;
