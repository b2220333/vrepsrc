...
CRigidBodyDyn_bullet283::CRigidBodyDyn_bullet283(CDummyShape* shape,CCollShapeDyn* collShapeDyn,bool forceStatic,bool forceNonRespondable,btDiscreteDynamicsWorld* bulletWorld)
{
    ...
    float linD=simGetEngineFloatParameter(sim_bullet_body_lineardamping,-1,_shape,NULL);
    float angD=simGetEngineFloatParameter(sim_bullet_body_angulardamping,-1,_shape,NULL);
    _rigidBody->setDamping(linD,angD);
    _rigidBody->setRestitution(simGetEngineFloatParameter(sim_bullet_body_restitution,-1,_shape,NULL));
    _rigidBody->setFriction(simGetEngineFloatParameter(sim_bullet_body_friction,-1,_shape,NULL));
