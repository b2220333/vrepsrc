...
CConstraintDyn_bullet283::CConstraintDyn_bullet283(CRigidBodyDyn* parentBody,CRigidBodyDyn* childBody,CDummyJoint* joint,btDiscreteDynamicsWorld* bulletWorld)
{
    ...
    float stopERP=simGetEngineFloatParameter(sim_bullet_joint_stoperp,-1,joint,NULL);
    float stopCFM=simGetEngineFloatParameter(sim_bullet_joint_stopcfm,-1,joint,NULL);
    float normalCFM=simGetEngineFloatParameter(sim_bullet_joint_normalcfm,-1,joint,NULL);
    if (_simGetJointType(joint)==sim_joint_revolute_subtype)
    {
